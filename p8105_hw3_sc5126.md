...
```
    ...
    ## # A tibble: 0 × 23
    ## # ℹ 23 variables: year <int>, locationabbr <chr>, locationdesc <chr>,
    ## #   class <chr>, topic <chr>, question <chr>, response <fct>,
    ## #   sample_size <int>, data_value <dbl>, confidence_limit_low <dbl>,
